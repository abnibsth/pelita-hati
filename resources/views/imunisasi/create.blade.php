            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="jenis_imunisasi" id="jenis_imunisasi" required
                        ...
                        <option value="HB-0" {{ old('jenis_imunisasi') === 'HB-0' ? 'selected' : '' }}>HB-0 (Hepatitis B0)</option>
                        <option value="BCG" {{ old('jenis_imunisasi') === 'BCG' ? 'selected' : '' }}>BCG (Tuberculosis)</option>
                        <option value="Polio-1" {{ old('jenis_imunisasi') === 'Polio-1' ? 'selected' : '' }}>Polio 1</option>
                        <option value="Polio-2" {{ old('jenis_imunisasi') === 'Polio-2' ? 'selected' : '' }}>Polio 2</option>
                        <option value="Polio-3" {{ old('jenis_imunisasi') === 'Polio-3' ? 'selected' : '' }}>Polio 3</option>
                        <option value="Polio-4" {{ old('jenis_imunisasi') === 'Polio-4' ? 'selected' : '' }}>Polio 4</option>
                        <option value="DPT-HB-1" {{ old('jenis_imunisasi') === 'DPT-HB-1' ? 'selected' : '' }}>DPT-HB 1</option>
                        <option value="DPT-HB-2" {{ old('jenis_imunisasi') === 'DPT-HB-2' ? 'selected' : '' }}>DPT-HB 2</option>
                        <option value="DPT-HB-3" {{ old('jenis_imunisasi') === 'DPT-HB-3' ? 'selected' : '' }}>DPT-HB 3</option>
                        <option value="Campak" {{ old('jenis_imunisasi') === 'Campak' ? 'selected' : '' }}>Campak</option>
                        <option value="Campak-Rubella" {{ old('jenis_imunisasi') === 'Campak-Rubella' ? 'selected' : '' }}>Campak-Rubella</option>
                ...
                <div>
                    ...
                    <select name="lokasi" id="lokasi" required
                        ...
                        <option value="Posyandu" {{ old('lokasi') === 'Posyandu' ? 'selected' : '' }}>Posyandu</option>
                        <option value="Puskesmas" {{ old('lokasi') === 'Puskesmas' ? 'selected' : '' }}>Puskesmas</option>
                        <option value="RS" {{ old('lokasi') === 'RS' ? 'selected' : '' }}>Rumah Sakit</option>
                ...
                <div>
                    ...
                    <input type="text" name="batch_number" id="batch_number"
                        ...
                        value="{{ old('batch_number') }}" placeholder="Opsional">
