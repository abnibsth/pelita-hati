...
@section('title', 'Tambah Kelurahan - SiPosyandu')
...
<div class="space-y-6">
    ...
    <div class="flex items-center space-x-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span class="text-gray-900 font-medium">Tambah Kelurahan</span>
    </div>

    <div class="bg-white rounded-lg shadow-sm p-6 max-w-2xl">
        <form action="{{ route($kelurahanPrefix . '.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Contoh: 3171010001</p>
                </div>
                ...
                <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                    <a href="{{ route($kelurahanPrefix . '.index') }}" class="px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                        Batal
                    </a>
