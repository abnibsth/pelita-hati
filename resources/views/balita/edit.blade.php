...
@section('title', 'Edit Data Balita - SiPosyandu')
...
@section('content')
<x-card>
    <form action="{{ route($balitaPrefix . '.update', $balita) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="nik" id="nik" maxlength="16" required
                    ...
                    value="{{ old('nik', $balita->nik) }}" placeholder="16 digit NIK">
            ...
            <div>
                ...
                <input type="date" name="birth_date" id="birth_date" required max="{{ date('Y-m-d') }}"
                    ...
                    value="{{ old('birth_date', $balita->birth_date->format('Y-m-d')) }}">
            ...
            <div>
                ...
                <select name="gender" id="gender" required
                    ...
                    <option value="L" {{ old('gender', $balita->gender) === 'L' ? 'selected' : '' }}>Laki-laki</option>
                    <option value="P" {{ old('gender', $balita->gender) === 'P' ? 'selected' : '' }}>Perempuan</option>
                </select>
            ...
            <div>
                ...
                <input type="text" name="mother_nik" id="mother_nik" maxlength="16" required
                    ...
                    value="{{ old('mother_nik', $balita->mother_nik) }}" placeholder="16 digit NIK">
            ...
            <div>
                ...
                <input type="text" name="parent_phone" id="parent_phone"
                    ...
                    value="{{ old('parent_phone', $balita->parent_phone) }}" placeholder="08xxxxxxxxxx">
            ...
            <div>
                ...
                <input type="text" name="rt_rw" id="rt_rw"
                    ...
                    value="{{ old('rt_rw', $balita->rt_rw) }}" placeholder="001/002">
        ...
        <div>
            ...
            <textarea name="address" id="address" rows="3"
                class="mt-1 block w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary-500 @error('address') border-red-500 @enderror">{{ old('address', $balita->address) }}</textarea>
            @error('address')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
        </div>

        <!-- Submit Buttons -->
        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
            <a href="{{ route($balitaPrefix . '.index') }}" class="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">Batal</a>
