...
@section('title', 'Tambah Posyandu - SiPosyandu')
...
<div class="space-y-6">
    <div class="flex items-center space-x-2 text-sm text-gray-500">
        ...
        <span>/</span>
        <span class="text-gray-900 font-medium">Tambah Posyandu</span>
    </div>

    <div class="bg-white rounded-lg shadow-sm p-6 max-w-2xl">
        <form action="{{ route($posyanduPrefix . '.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Contoh: POSYANDU-001</p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="jadwal_minggu_ke" id="jadwal_minggu_ke" required
                            ...
                            <option value="1" {{ old('jadwal_minggu_ke') == '1' ? 'selected' : '' }}>1</option>
                            <option value="2" {{ old('jadwal_minggu_ke') == '2' ? 'selected' : '' }}>2</option>
                            <option value="3" {{ old('jadwal_minggu_ke') == '3' ? 'selected' : '' }}>3</option>
                            <option value="4" {{ old('jadwal_minggu_ke') == '4' ? 'selected' : '' }}>4</option>
                        </select>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="time" name="jadwal_jam_mulai" id="jadwal_jam_mulai" value="{{ old('jadwal_jam_mulai') }}" required
                    ...
                    <div>
                        ...
                        <input type="time" name="jadwal_jam_selesai" id="jadwal_jam_selesai" value="{{ old('jadwal_jam_selesai') }}" required
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Dapat diubah nanti setelah posyandu dibuat</p>
                </div>

                <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                    <a href="{{ route($posyanduPrefix . '.index') }}" class="px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition">
                        Batal
                    </a>
